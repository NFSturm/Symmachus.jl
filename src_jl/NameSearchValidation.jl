...
@doc """
    get_performance_metrics(names::Vector{String}, encoding_model::Tuple{Symbol, Symbol}, encoded_speech_acts::DataFrame, encoded_activities::DataFrame)

Iterative version of `validate_search`. Iterates over `names` and generates aggregate performance statistics.
"""
function get_performance_metrics(names::Vector{String}, encoding_model::Tuple{Symbol, Symbol}, encoded_speech_acts::DataFrame, encoded_activities::DataFrame)
...
@info "Retrieving performance metrics from models…"
